...
class Program
{
    static void Main()
    {
        ...
        while (player.Health > 0)
        {
            ...
            {
                Console.WriteLine($"**{player.Name}** пал в бою... Ваш итоговый счет: {player.Score}");
                break;
            }
        }
    }
    ...
    static Weapon GenerateRandomWeapon(Random random)
    {
        List<Weapon> weapons = new List<Weapon>
        {
            ...
            new Weapon("Грань Бесконечности", 30, 100),
            new Weapon("Дракктар", 15, 100)
        };
...
class Player
{
    ...
    public void UseAid()
    {
        if (Aid != null)
        {
            ...
            Console.WriteLine($"**{Name}** использовал аптечку и восстановил {Aid.HealAmount}hp!");
            Aid = null;
        }
        else
        {
